...
| Compounds        | `components/compounds/` | `Compounds/<Name>`          | Stable arrangement of **peer** primitives, each carrying its own semantic role. Generic (SwitchRow, FormRow) and Aventuras-specific (ListRow, Toolbar, SaveBar, JSONViewer, ImportDialog) live together here.                   |
